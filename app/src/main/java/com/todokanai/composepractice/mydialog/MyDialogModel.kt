package com.todokanai.composepractice.mydialog
...
class MyDialogModel(val context: Context,val fileList: MutableStateFlow<Array<File>>) {
    ...
    /*
    @Composable
    fun infoDialogCompose(selectedList: List<File>){
        val mDialog = Dialog(context)
        ...
        Column(
            ...
            MyTextView(text = "Todo", textStyle = TextStyle())
        }
    }
